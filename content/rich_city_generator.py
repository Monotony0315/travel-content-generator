...
오늘은 관광객들이 잘 안 가는 숨은 명소도 포함되어 있어서, 진짜 {city}의 매력을 느끼실 수 있을 거예요. 평소보다 여유롭게 다녀오시는 것을 추천드려요."""
    ...
    def _calculate_total_costs(self, country: str, cur_sym: str, days: int) -> Dict:
        # (budget_hotel, luxury_hotel, budget_food, luxury_food) per day
        # 환율 고려한 적절한 현지 통화 금액
        base = {
            # 유로화 국가 (1유로 ≈ 1,500원)
            "France": (85, 350, 40, 100), "Italy": (80, 300, 35, 90),
            "Spain": (70, 280, 30, 80), "Germany": (75, 300, 35, 90),
            "Netherlands": (90, 320, 40, 95), "Austria": (80, 300, 35, 90),
            "Greece": (60, 250, 25, 75), "Portugal": (60, 250, 25, 75),
            "Ireland": (85, 320, 40, 95), "Belgium": (80, 300, 35, 90),
            "Finland": (90, 320, 40, 95), "Luxembourg": (95, 350, 42, 100),
            # 비유로 유럽
            "UK": (80, 300, 35, 80),  # 파운드 (1파운드 ≈ 1,700원)
            "Czech Republic": (2500, 10000, 800, 2500),  # 코루나 (1코루나 ≈ 60원)
            "Hungary": (20000, 80000, 6000, 18000),  # 포린트 (1포린트 ≈ 3.6원)
            "Poland": (300, 1200, 80, 250),  # 즈워티 (1즈워티 ≈ 340원)
            "Sweden": (900, 3500, 300, 800),  # 크로나 (1크로나 ≈ 130원)
            "Norway": (1000, 4000, 350, 900),  # 크로네 (1크로네 ≈ 125원)
            "Denmark": (650, 2500, 250, 700),  # 크로네 (1크로네 ≈ 200원)
            "Switzerland": (120, 450, 50, 120),  # 스위스 프랑 (1프랑 ≈ 1,600원)
            # 아시아
            "Thailand": (800, 3500, 300, 800),  # 바트 (1바트 ≈ 40원)
            "Singapore": (80, 350, 25, 80),  # 싱가포르 달러 (1달러 ≈ 1,000원)
            "Malaysia": (180, 800, 60, 180),  # 링깃 (1링깃 ≈ 300원)
            "Indonesia": (400000, 1800000, 120000, 350000),  # 루피아 (1루피아 ≈ 0.09원)
            "Vietnam": (600000, 2500000, 200000, 500000),  # 동 (1동 ≈ 0.06원)
            "Philippines": (2500, 10000, 800, 2000),  # 페소 (1페소 ≈ 25원)
            "Japan": (12000, 50000, 4000, 12000),  # 엔 (1엔 ≈ 9.2원)
            "Taiwan": (1500, 6000, 500, 1500),  # 대만 달러 (1달러 ≈ 43원)
            "Hong Kong": (450, 1800, 150, 450),  # 홍콩 달러 (1달러 ≈ 175원)
            "South Korea": (80000, 350000, 30000, 100000),  # 원
            "China": (350, 1500, 120, 350),  # 위안 (1위안 ≈ 190원)
            "India": (3500, 15000, 1200, 3500),  # 루피 (1루피 ≈ 16.5원)
            # 미주
            "USA": (120, 450, 50, 120),  # 달러 (1달러 ≈ 1,380원)
            "Canada": (130, 480, 55, 130),  # 캐나다 달러 (1달러 ≈ 1,020원)
            "Mexico": (1300, 5000, 450, 1300),  # 페소 (1페소 ≈ 82원)
            "Brazil": (350, 1300, 120, 350),  # 헤알 (1헤알 ≈ 260원)
            "Argentina": (45000, 180000, 15000, 45000),  # 페소 (1페소 ≈ 1.5원)
            "Chile": (55000, 220000, 20000, 60000),  # 페소 (1페소 ≈ 1.5원)
            "Peru": (180, 750, 60, 180),  # 솔 (1솔 ≈ 370원)
            # 오세아니아
            "Australia": (130, 480, 55, 130),  # 호주 달러 (1달러 ≈ 920원)
            "New Zealand": (140, 520, 60, 140),  # 뉴질랜드 달러 (1달러 ≈ 830원)
            "Fiji": (90, 350, 35, 90),  # 피지 달러 (1달러 ≈ 620원)
            # 중동
            "UAE": (350, 1500, 120, 350),  # 디르함 (1디르함 ≈ 375원)
            "Turkey": (900, 3800, 350, 900),  # 리라 (1리라 ≈ 40원)
            "Israel": (350, 1500, 120, 350),  # 셰켈 (1셰켈 ≈ 370원)
            "Jordan": (50, 200, 18, 50),  # 디나르 (1디나르 ≈ 1,950원)
            "Egypt": (800, 3500, 300, 800),  # 파운드 (1파운드 ≈ 28원)
            "Morocco": (400, 1800, 150, 400),  # 디르함 (1디르함 ≈ 137원)
            # 아프리카
            "South Africa": (850, 3500, 300, 850),  # 랜드 (1랜드 ≈ 75원)
            "Kenya": (8000, 35000, 3000, 8000),  # 실링 (1실링 ≈ 10.7원)
            "Tanzania": (130000, 550000, 50000, 130000),  # 실링 (1실링 ≈ 0.55원)
            # 휴양지
            "Maldives": (1500, 8000, 600, 1500),  # 루피야 (1루피야 ≈ 90원) - 리조트 제외
            "Seychelles": (1300, 5500, 450, 1300),  # 루피 (1루피 ≈ 102원)
            "Mauritius": (2500, 10000, 900, 2500),  # 루피 (1루피 ≈ 30원)
            "Bali": (350000, 1500000, 120000, 350000),  # 루피아 (동일)
            "Phuket": (1200, 5000, 400, 1200),  # 바트 (동일)
            "Sri Lanka": (6000, 25000, 2000, 6000),  # 루피 (1루피 ≈ 4.6원)
            "Cambodia": (180000, 800000, 60000, 180000),  # 리엘 (1리엘 ≈ 0.34원)
            "Myanmar": (50000, 220000, 18000, 50000),  # 차트 (1차트 ≈ 0.66원)
            "Laos": (250000, 1100000, 80000, 250000),  # 킵 (1킵 ≈ 0.064원)
        }
    ...
    def _to_krw(self, amount: int, country: str) -> str:
        """대략적인 원화 환산 - 2024년 기준 환율"""
        # 환율 (1 현지 통화 = ? 원)
        rates = {
            # 유로화 (1유로 ≈ 1,480원)
            "France": 1480, "Italy": 1480, "Spain": 1480, "Germany": 1480,
            "Netherlands": 1480, "Austria": 1480, "Greece": 1480, "Portugal": 1480,
            "Ireland": 1480, "Belgium": 1480, "Finland": 1480, "Luxembourg": 1480,
            # 비유로 유럽
            "UK": 1730,  # 1파운드
            "Czech Republic": 59,  # 1코루나
            "Hungary": 3.7,  # 1포린트
            "Poland": 370,  # 1즈워티
            "Sweden": 128,  # 1크로나
            "Norway": 125,  # 1크로네
            "Denmark": 198,  # 1크로네
            "Switzerland": 1620,  # 1프랑
            "Croatia": 1480,  # 유로 사용
            # 아시아
            "Thailand": 39.5,  # 1바트
            "Singapore": 1010,  # 1싱가포르 달러
            "Malaysia": 310,  # 1링깃
            "Indonesia": 0.091,  # 1루피아
            "Vietnam": 0.059,  # 1동
            "Philippines": 24.5,  # 1페소
            "Japan": 9.2,  # 1엔
            "Taiwan": 42.5,  # 1대만 달러
            "Hong Kong": 175,  # 1홍콩 달러
            "South Korea": 1,  # 원
            "China": 192,  # 1위안
            "India": 16.4,  # 1루피
            "Cambodia": 0.34,  # 1리엘
            ...
            "Colombia": 0.32,  # 1페소
            "Peru": 365,  # 1솔
            "Ecuador": 1380,  # 미국 달러 사용
            "Panama": 1380,  # 미국 달러 사용
            # 오세아니아
            "Australia": 905,  # 1호주 달러
            "New Zealand": 815,  # 1뉴질랜드 달러
            "Fiji": 615,  # 1피지 달러
            "Papua New Guinea": 345,  # 1키나
            # 중동
            "UAE": 375,  # 1디르함
            "Turkey": 40.2,  # 1리라
            "Israel": 375,  # 1셰켈
            ...
            "Kuwait": 4480,  # 1디나르
            "Bahrain": 3660,  # 1디나르
            "Saudi Arabia": 368,  # 1리알
            "Iran": 0.032,  # 1리알
            # 아프리카
            "South Africa": 75.2,  # 1랜드
            "Kenya": 10.6,  # 1실링
            "Tanzania": 0.54,  # 1실링
            "Uganda": 0.37,  # 1실링
            "Rwanda": 10.3,  # 1프랑
            ...
            "Egypt": 27.8,  # 1파운드
            "Ethiopia": 24.2,  # 1비르
            "Madagascar": 0.30,  # 1아리아리
            "Mauritius": 30.2,  # 1루피
            "Seychelles": 102,  # 1루피
            # 휴양지
            "Maldives": 90.5,  # 1루피야
            "Bali": 0.091,  # 1루피아 (인도네시아)
            "Phuket": 39.5,  # 1바트 (태국)
            "Sri Lanka": 4.6,  # 1루피
            "Fiji": 615,  # 1피지 달러
            "Seychelles": 102,  # 1루피
        ...
        rate = rates.get(country, 1380)  # 기본: 미국 달러 환율
        krw = int(amount * rate)
        
        # 형식화된 출력
        if krw >= 100000000:
            return f"{krw // 100000000}억{((krw % 100000000) // 10000)}만원"
        elif krw >= 10000:
            return f"{krw // 10000}만{krw % 10000:,}원"
        else:
            return f"{krw:,}원"
